...
import 'package:firstfirebase/E-Commerce/LoginScreen.dart';
...
class _mysplashscreenState extends State<mysplashscreen> {
  ...
  void initState() {
    ...
    super.initState();
    Timer(Duration(seconds: 4),()=> Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) => LoginScreenShop(),)));
  }
